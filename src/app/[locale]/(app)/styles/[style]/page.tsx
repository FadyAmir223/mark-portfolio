...
export default function Style({ params: { locale, style } }: StyleProps) {
  ...
  return (
    <main className='container pb-12 pt-20'>
      <div className='flex flex-col-reverse gap-12 text-center lg:flex-row lg:text-start'>
        ...
        <div className='md:mx-auto md:max-w-[600px] lg:mx-[reset] lg:w-1/2 lg:max-w-[reset]'>
          <h2 className='mb-4 block text-2xl font-bold tracking-wider md:text-3xl lg:text-4xl'>
            {styleWord}
          </h2>
          <p className='md:text-lg lg:text-xl lg:leading-8'>{desc}</p>
        </div>
      </div>
    </main>
  )
